...
namespace CensusAnalyzerTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delimeterIndianCensusFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\WrongIndiaStateCensusData.csv";
        static string wrongIndianCensusFileType = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\IndiaStateCensusData.txt";

        static string indianStateCodeFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\IndiaStateCode.csv";
        static string wrongIndianStateCodeFileType = @"E:\c# git push\IndianStateAnalyzerIndianStateAnalyzer\CSVFiles\IndiaStateCode.txt";
        static string delimeterIndianStateCodeFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\DelimiterIndiaStateCode.csv";
        static string wrongHeaderStateCodeFilePath = @"E:\c# git push\IndianStateAnalyzer\IndianStateAnalyzer\CSVFiles\WrongIndiaStateCode.csv";

        IndianStateAnalyzer.CensusAnalyzer censusAnalyzer;
